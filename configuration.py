...
def init_driver():
    ...
    return webdriver.Chrome('/Users/andreafavia/PycharmProjects/video/chromedriver', options=options)
...
def arg_parser():
    ...
    parser.add_argument('-start', '-s', help='number of videolectures to start downloading [1..]', nargs='?', type=str)
